...
def analyze_with_gpt(text):
    try:
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",  # هنا التعديل
            messages=[
...
أيوه تمام، **خلّ المفتاح نفسه زي ما هو**،  
بس نغيّر النموذج من `"gpt-4o"` إلى `"gpt-3.5-turbo"`، وراح يشتغل معك **بدون ما تدفع ولا ريال**.

---

### تفضل هذا هو كود `main.py` كامل (محدث لاستخدام `gpt-3.5-turbo`) وجاهز:
