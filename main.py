...
**أخرج النتيجة بصيغة جدول Markdown منسق بهذا الشكل:**

| اسم العنصر | تحقق (نعم/لا) | الدرجة من 2 | النسبة المحققة |
|------------|----------------|--------------|------------------|

**ثم أضف في الأسفل:**
- **المجموع النهائي للنسب (من 100%).**
- **الدرجة النهائية من 5.**
- **ملاحظات ذكية توضح لماذا اعتبرت كل عنصر متحققًا، مع ذكر العبارات الدالة من الشاهد إن وُجدت.**
