...
def index():
    ...
    if request.method == 'POST':
        ...
        if input_text.strip():
            prompt = f"""
أنت محلل تربوي متخصص في تقييم أداء المعلمين بناءً على الشواهد المكتوبة أو المصورة. مهمتك تحليل الشاهد التالي باستخدام العناصر الرسمية التالية من وزارة التعليم (11 عنصر):
...
اعرض العناصر كلها دائمًا داخل جدول HTML منسق باستخدام <table><tr><th><td> ويحتوي على:
- اسم العنصر
- درجة التحقق
...
ثم ملاحظات تحليلية تفصيلية لكل عنصر.
لا تذكر أسماء أشخاص غير واردة مثل "المعلمة مريم".
...
تمام، تفضل يا علي:  
الآن أرسل لك الملفين **كاملين نصياً** تقدر تنسخهم مباشرة.
...
مهمتك تحليل الشاهد التالي باستخدام العناصر الرسمية التالية من وزارة التعليم (عددها 11)، وتوزيع الدرجات كما يلي:
- إذا لم يوجد أي شاهد → الدرجة = 1 من 5
- إذا وُجد شاهد واحد فقط → الدرجة = 4 من 5
- إذا وُجد شاهدين أو أكثر → الدرجة = 5 من 5
